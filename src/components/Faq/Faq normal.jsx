    ...
    return (
        <section className="faq">
            <div className="container">
                ...
                <div className="faq__accordion accordion-content">

                    <div className="accordion accordion-1">
                        <button 
                            className="accordion__control text text_lead text_bold text_ebony-gray button">
                            Aliquet lectus urna viverra in odio?
                        </button>
                        <div 
                            className="accordion__content text text_base text_regular text_storm-gray">
